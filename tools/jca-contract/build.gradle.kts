...
sourceSets {
    main { kotlin.setSrcDirs(listOf("../../modules/environment/discovery/src/main/kotlin", "src/main/kotlin")) }
    test { kotlin.setSrcDirs(listOf("../../modules/environment/discovery/src/test/kotlin")) }
}
